...
public class FinishOrderAsGuest {
    ...
    public void placeOrderAsGuestTest() {
        ...
        WebElement confirmationOrderElement = driver.findElement(By.xpath("//*[@id=\"content\"]/p[1]"));
        String confirmText = confirmationOrderElement.getText();
        System.out.println(confirmText);

        Assert.assertEquals(confirmText, "Your order has been successfully processed!");
